...
var app = (function () {
    ...
    const giphyApiKey = "bqfL5T0sxW6XulHgKFuBt8leCxRGfT1r";
    async function fetchGif(textSearch) {
        try {
            const response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=${giphyApiKey}&q=${textSearch}&limit=50&offset=0&rating=PG-13&lang=pt`);
    ...
    async function fetchGifs(event) {
        ...
        if (!validTextSearch(search) || event.key !== 'Enter')
            return;
        try {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let $gifShowing;
    	validate_store(gifShowing, 'gifShowing');
    	component_subscribe($$self, gifShowing, $$value => $$invalidate(0, $gifShowing = $$value));
    	...
    	$$self.$capture_state = () => ({ gifShowing, reset, $gifShowing });
    	return [$gifShowing];
    }
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_store(gifShowing, 'gifShowing');
    	component_subscribe($$self, gifShowing, $$value => $$invalidate(0, $gifShowing = $$value));
    	validate_store(textSearch, 'textSearch');
    	component_subscribe($$self, textSearch, $$value => $$invalidate(1, $textSearch = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*$textSearch*/ ctx[1]);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$textSearch*/ 2 && input.value !== /*$textSearch*/ ctx[1]) {
    				set_input_value(input, /*$textSearch*/ ctx[1]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let if_block = !/*$gifShowing*/ ctx[0] && create_if_block$1(ctx);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [$gifShowing, $textSearch, input_input_handler];
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$allGifs*/ 2 && !src_url_equal(video.src, video_src_value = /*gif*/ ctx[2].src)) {
    ...
    function create_fragment$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*$gifShowing*/ ctx[0] && create_if_block(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_store(gifShowing, 'gifShowing');
    	component_subscribe($$self, gifShowing, $$value => $$invalidate(0, $gifShowing = $$value));
    	validate_store(allGifs, 'allGifs');
    	component_subscribe($$self, allGifs, $$value => $$invalidate(1, $allGifs = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    function create_fragment(ctx) {
    	...
    	gifs = new Gifs({ $$inline: true });
    	hint = new Hint({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(window, "keypress", /*keypress_handler*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Hint, Search, Gifs, fetchGifs });
