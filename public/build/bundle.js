...
var app = (function () {
    ...
    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { gifShowing: 0, reset: 1 });
    ...
    class Hint extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { gifShowing: 0, textSearch: 1 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 5, 3, 91);
    		},
    		m: function mount(target, anchor) {
    ...
    class Search extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { gifShowing: 1, value: 0 });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*allGifs*/ 16 && !src_url_equal(video.src, video_src_value = /*gif*/ ctx[7].src)) {
